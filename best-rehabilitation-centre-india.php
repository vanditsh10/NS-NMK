...
<title>Best Rehabilitation Centre in Delhi NCR and Himachal Pradesh, Drug De-addiction centre in Delhi, Best Rehab in Delhi, Nasha Mukti  Kendra</title>
        ...
        <div class="lx-article__grid">
          ...
          <div class="lx-article__main">
            ...
            <div class="lx-prose">
                ...
                <p>Naya Savera follows a 12- step programme which works as a guideline for self acceptance for an addict and generating awareness that Drug abuse is not a taboo but a disease that can be cured.</p>
                <p>This treatment lasts for the maximum time of 6 months where an addict follows a routine plan from morning to the night itself, you can find our routine activities in the <a href="/gallery.html">Photo Gallery.</a></p>
                <p><strong>Naya Savera focus on these major factors for detoxification</strong></p>
                <p>Rehabilitation requires the treatment of the harm that has been done by excessive drug abuse thereby Naya Savera provides with doctor-approved medication to the new family member for its detoxification. </p>
                <p>We do not just rely on the medication but also prepare the addict for a brighter and happier path through mental counseling by our renowned and certified psychiatrist. </p>
