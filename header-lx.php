    ...
    <div class="lx-bar">
      ...
      <nav class="lx-nav" id="lxNav" aria-label="Main">
        <ul>
          ...
          <li<?php if ($lx_current === 'faq') echo ' class="is-current"'; ?>><a href="faq.html">FAQ</a></li>
          <li<?php if ($lx_current === 'enquiry') echo ' class="is-current"'; ?>><a href="enquiry.html">Enquiry</a></li>
